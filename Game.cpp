    ...
    for (int j = 0; j < TILE_DIMENSION; j++) {
      for (int k = 0; k < TILE_DIMENSION; k++) {
        ...
        this->m_s_sky[coord].setPosition(
            (j * TILE_DIMENSION) + (i * TILE_DIMENSION * TILE_DIMENSION),
            k * TILE_DIMENSION);
      }
    }
  }
    ...
    while (ptr) {
      ...
      if (ptr->type == "brick") {
        this->m_s_objects->body =
            new Ground(&this->m_t_brick, x, y, 272, 112, 16, 16, ptr->type);
...
void Game::updateInfos() {
  ...
  this->m_s_score_digit_1->setTextureRect(
      sf::IntRect(charactersSet[currentScore[0]][0],
                  charactersSet[currentScore[0]][1], 8, 8));
  this->m_s_score_digit_2->setTextureRect(
      sf::IntRect(charactersSet[currentScore[1]][0],
                  charactersSet[currentScore[1]][1], 8, 8));
  this->m_s_score_digit_3->setTextureRect(
      sf::IntRect(charactersSet[currentScore[2]][0],
                  charactersSet[currentScore[2]][1], 8, 8));
  this->m_s_score_digit_4->setTextureRect(
      sf::IntRect(charactersSet[currentScore[3]][0],
                  charactersSet[currentScore[3]][1], 8, 8));
  this->m_s_score_digit_5->setTextureRect(
      sf::IntRect(charactersSet[currentScore[4]][0],
                  charactersSet[currentScore[4]][1], 8, 8));
  this->m_s_score_digit_6->setTextureRect(
      sf::IntRect(charactersSet[currentScore[5]][0],
                  charactersSet[currentScore[5]][1], 8, 8));
